...
# Instaniate the trainer object to drive the model training
learning_rate = 0.2
lr_schedule = C.learning_parameter_schedule(learning_rate)
learner = C.sgd(z.parameters, lr_schedule)
trainer = C.Trainer(z, (loss, label_error), [learner]) # input, output, optimizer
...
minibatch_size = 64
num_samples_per_sweep = 60000	# Here sweep is epoch
